...
@teacher.route(
    "/course/<string:course_id>/assignments/<string:assignment_id>/submissions",
    methods=["GET"],
)
...
@teacher.route(
    "/course/<string:course_id>/assignments/<string:assignment_id>/submissions/<string:submission_id>",
    methods=["POST"],
)

...
@student.route("/submit/<class_id:string>/<assignment_id:string>", methods=["POST"])
...
@student.route("/assignments/<class_id:string>/", methods=["GET"])
...
# This could possibly instead just use /assignments/<assignment_id:string>/
# and then we could search through classes to find the assignment 
@student.route("/assignments/<class_id:string>/<assignment_id:string>/", methods=["GET"])

...
function log_firstName() {
  if (localStorage.getItem('reg_name') != null) {
    document.getElementById('greetings').innerHTML =
      'Доброго ранку' + "<span id='spanName'>, " + localStorage.getItem('reg_name') + '</span>';
...
function modalOpen(id) {
  ...
  if (id == 'group1') {
    ...
    document.getElementById('class-name').innerHTML =
      'Завантаження оцінок для ' + localStorage.getItem('group1') + ' класу';
  } else if (id == 'group2') {
    group = 'group2';

    document.getElementById('class-name').innerHTML =
      'Завантаження оцінок для ' + localStorage.getItem('group2') + ' класу';

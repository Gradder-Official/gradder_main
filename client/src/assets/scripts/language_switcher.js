...
$('.custom-option').on('click', function () {
  $(this).parents('.custom-select-wrapper').val($(this).data('value'));
  $('.custom-options').css('opacity', '0');
  langAppear('none', 70);
...
$(function () {
  ...
  dictionary = {
    рус: {
      ...
      _solution: 'Решение',
      _problemText:
        'Единственными надежными способами для родителей узнать информацию об оценках являются телефонный звонок или визиты в школу. Текущая система отслеживания успеваемости требует от классных руководителей немало монотонной работы, ведь эта система слишком устарела.',
      _solutionText:
        'Родители и ученики будут получать еженедельную рассылку о состоянии успеваемости на протяжении недели через Viber, WhatsApp и другие. Классные руководители смогут передавать информацию об оценках в 100 раз быстрее благодаря AI системе обработки информации.',
    ...
    укр: {
      ...
      _solution: 'Рішення',
      _problemText:
        'Єдиним надійним способом для батьків і учнів дізнатися інформацію про оцінки є телефонний дзвінок або особисті візити до школи. Наявна система відслідковування успішності вимагає від класних керівників чимало монотонної роботи, адже ця система є застарілою та до сих пір базованою лише на папері.',
      _solutionText:
        'Батьки та учні отримуватимуть щотижневу розсилку про стан успішності протягом поточного тижня через Viber, WhatsApp та інші. Класні керівники зможуть передавати інформацію про оцінки в 100 разів швидше завдяки системі обробки інформації, що використовує штучний інтелект.',
    ...
    eng: {
      ...
      _solutionText:
        'Parents and students get weekly grade reports through Viber, WhatsApp, Telegram, or Facebook Messenger. Academic advisors can create monthly reports 100 times faster thanks to an Artificial Intelligence-driven scanner app created by Gradder.',
